...
import { ImputBusquedaMovil } from "./ImputBusquedaMovil";
...
function HeaderRuadis() {
  ...
  return (
    <header className="navbar bg-base-100 mb-0 shadow-xl" id="navegacion">
      <div className="navbar-start items">
        <div className="hamburguesa dropdown" id="botonOpenMenu">
          <button
            type="button"
            tabIndex="0"
            className="text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300 btn btn-ghost"
          >
            <svg
          ...
          <div
            className="dropdown-content menuDesplegable bg-base-100 w-96 max-w-[calc(100%-3rem)] pl-6"
            id="clickbox"
            tabIndex="0"
          >
            <div>
            ...
            <ul
              className="flex mt-2 menu shadow bg-base-100 space-y-6 lg:space-y-2 border-l border-slate-100 dark:border-slate-700"
              id="MenuDesplegable"
            >
              <li className=" flex flex-row border-l -ml-px border-transparent hover:border-slate-400 dark:hover:border-slate-500 text-slate-700 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-300">
                <a className="pl-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
      ...
      <div className="navbar-center logo dark:text-slate-400 dark:hover:text-slate-300">
